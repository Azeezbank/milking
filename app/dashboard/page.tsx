        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition">
            ...
            <div className={`text-sm ${absoluteChange >= 0 ? "text-green-600" : "text-red-600"}`}>
              ...
              ({percentChange}%) {absoluteChange >= 0 ? "Above" : "Below"} {filterRange === "day" ? "Yesterday" : filterRange === "week" ? "Last Week" : filterRange === "month" ? "Last Month" : "Year"}
            </div>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition">
            <div className="flex items-center gap-3 text-sky-600"><Users /><p className="text-sm text-gray-500">Active Staff</p></div>
